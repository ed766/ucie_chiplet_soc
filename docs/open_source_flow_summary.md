...
| GCC C / RV32 architectural differential | `make -C chiplet_extension firmware-c-closure firmware-c-coverage` | `docs/reference/compiled_firmware_verification.md` | 35 named programs plus 50 deterministic seeded executions, `176 / 176` points, `88 / 88` event-correlated crosses, split code/data images, precise traps/interrupts, APB/DMA checking, independent instruction/memory/CSR state, `11 / 11` mutation sensitivity, and native code coverage | Independent project checker, not Spike/Sail or RISC-V compliance certification |
