...
def infer_detail(log_text: str, returncode: str) -> str:
    patterns = [
        ...
        ("dma_config_violation", "dma_config"),
        ("dma_completion_violation", "dma_completion"),
        ("dma_memory_compare_violation", "dma_memory_compare"),
        ("dma_irq_mask_violation", "dma_config"),
        ("memory_integrity_violation", "memory_integrity"),
        ("memory_retention_violation", "memory_retention"),
        ("memory_bank_conflict_violation", "memory_banking"),
        ("memory_read_visibility_violation", "memory_banking"),
        ("memory_write_reject_violation", "memory_banking"),
        ("memory_power_mode_violation", "memory_retention"),
    ...
    with manifest_path.open(newline="") as handle:
        ...
        for entry in reader:
            ...
            row = {
                ...
                "dma_desc_completed": result_fields.get("dma_desc_completed", ""),
                "dma_irq_count": result_fields.get("dma_irq_count", ""),
                "dma_error_count": result_fields.get("dma_error_count", ""),
                "dma_mem_mismatch": result_fields.get("dma_mem_mismatch", ""),
                "cov_hits": cov_hits,
                "cov_total": cov_total,
                "cov_pct": cov_pct,
                ...
                "power_csv": result_fields.get("power_csv", entry.get("power_csv", "")),
